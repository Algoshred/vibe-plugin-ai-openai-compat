...
```bash
vibe plugin install @vibecontrols/vibe-plugin-ai-openai-compat
```

Or install the npm package directly into an existing project that hosts the VibeControls agent:

```bash
bun add @vibecontrols/vibe-plugin-ai-openai-compat
# or
npm install @vibecontrols/vibe-plugin-ai-openai-compat
```
...
- npm: <https://www.npmjs.com/package/@vibecontrols/vibe-plugin-ai-openai-compat>
- Source: <https://github.com/algoshred/vibe-plugin-ai-openai-compat>
- Plugin contract / SDK: <https://github.com/algoshred/vibecontrols-plugin-sdk>
- Plugin catalogue: <https://vibecontrols.com/plugins/ai-openai-compat>
